		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappparkinglotsrv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappparkinglotsrv-display": {
								"semanticObject": "comappparkinglotsrv",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.parkinglotsrv",
									"url": sap.ui.require.toUrl("com/app/parkinglotsrv")
								}
							}
						}
					}
